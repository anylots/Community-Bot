...
def generate_Article_Steps(vector_store: SupabaseVectorStore, stats_db):
    ...
    if button:
        ...
        # response += "\n"
        # response += "\n"
        st.markdown("### <center>Morphism: A Next-Generation Layer2 Platform</center>")
...
def generate_Article_full(vector_store: SupabaseVectorStore, stats_db):
    ...
    value = "Please write a white paper about Ethereum layer2, with the technical key being the first Optimal ZK Rollup Solution for Ethereum, where the challenger uses zk rollup as proof of fraud"
